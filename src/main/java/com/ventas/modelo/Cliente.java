...
/**
 * Clase que representa a un Cliente dentro del sistema de ventas. Contiene
...
public class Cliente {
     ...
     * @param metodoPago Método de pago (por ejemplo: "Efectivo", "Tarjeta",
     * etc.)
     */
    ...
    public String toString() {
        return nombreCompleto; // o el campo que quieras mostrar
    }
}
