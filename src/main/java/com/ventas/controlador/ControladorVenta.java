...
/**
 * Controlador encargado de manejar la lógica de ventas, incluyendo el uso de un
 * carrito, validaciones, actualizaciones de stock y operaciones relacionadas a
 * las ventas
 *
 *
 * @author Jona Vicesar
...
public class ControladorVenta {
 ...
 private static final HashMap<Producto, Integer> carritoProductos = new HashMap<>();
    ...
    /**
     * Crea una venta utilizando los productos del carrito y un cliente
     * existente
     *
    ...
    /**
     * Disminuye la cantidad de un producto en el carrito Si la cantidad queda
     * en 0, se elimina del carrito
     *
     * @param nombreProducto Nombre del producto
    ...
    public void guardarDatos(){
        repositorioVentas.guardarDatos();
    }

    public boolean anularVenta(int idVenta) {
        return repositorioVentas.anularVenta(idVenta);
    }

    public List<Venta> obtenerVentasEntreFechas(LocalDate desde, LocalDate hasta) {
        return repositorioVentas.obtenerVentasEntreFechas(desde, hasta);
    }

    public List<Venta> listarVentasAnuladas() {
        return repositorioVentas.listarVentasAnuladas();
    }

    public List<Venta> filtrarPorFecha(LocalDate fecha) {
        return repositorioVentas.filtrarPorFecha(fecha);
    }

    public List<Venta> filtrarPorCliente(int documentoCliente) {
        return repositorioVentas.filtrarPorCliente(documentoCliente);
    }
    
    public int cantidadVentas(){
        return repositorioVentas.cantidadVentas();
    }
}
